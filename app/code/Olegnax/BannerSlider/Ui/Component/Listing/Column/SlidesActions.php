...
class SlidesActions extends \Magento\Ui\Component\Listing\Columns\Column {

	const URL_PATH_DELETE = 'bannerslider/slides/delete';

	protected $urlBuilder;

	const URL_PATH_EDIT = 'bannerslider/slides/edit';
				...
				if (isset($item['slider_id'])) {
					$item[$this->getData('name')] = [
						...
						'delete' => [
							...
							'label' => __('Delete'),
							'confirm' => [
								'title' => __('Delete "%1"', $item['slider_id']),
								'message' => __('Are you sure you wan\'t to delete a "%1" record?', $item['slider_id'])
							]
						]
					];
				}
